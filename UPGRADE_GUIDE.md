...
#### After (v3.0.0) — Optional Enhancement
```dart
const myLocale = TimestampLocale(
  justNow: 'Baru saja',
  yesterday: 'Kemarin',
...
**Note**: This is a major version bump (v3.0.0) due to the new `TimestampLocale` parameters, but existing code will continue to work without modifications thanks to default values.
